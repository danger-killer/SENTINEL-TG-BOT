...
// ✅ শুধু এই 2 টা লাইন Change - ভিডিও -> ছবি
const IMAGE_URL = "https://drive.google.com/uc?export=view&id=14y10-G8gvIrptmMcSaqy5wOWPaVTKcd-";
const CACHE_IMAGE_PATH = path.join(process.cwd(), "data", "cache_namaz_image.jpg");
...
async function downloadImage(){
  try{
    ...
    const r = await axios({ method: "GET", url: IMAGE_URL, responseType: "stream", headers: { 'User-Agent': 'Mozilla/5.0' } });
...
"হে আল্লাহ! আমাকে নামাজ কায়েমকারী বানাও এবং আমার বংশধরদেরও"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
