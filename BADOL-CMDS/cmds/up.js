...
module.exports = {
  ...
  BADOL: async function ({ event, api, message }) {
    ...
    try {
        ...
        // Background - no URL, solid gradient
        ...
        // Try to load avatar from local or skip
        try {
            // Use bot's own photo from Telegram if possible - no external URL
        ...
        drawBox(420,130,330,85,"BOT DEVELOPER","MOHAMMAD BADOL","#00f2fe");
