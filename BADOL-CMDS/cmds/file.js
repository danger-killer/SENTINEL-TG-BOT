...
module.exports = {
  config: { name: "fm", aliases: ["file"], author: "MOHAMMAD BADOL", version: "12.0 ALL FIXED", cooldown: 2, role: 1, description: "FM Button fixed + add/del/get", category: "admin", usePrefix: false },
