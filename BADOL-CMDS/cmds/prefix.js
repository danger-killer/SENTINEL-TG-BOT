...
module.exports = {
  ...
  BADOL: async function ({ event, api, args, message, chatId }) {
    try {
      ...
      const ownerName = cfg.ownerName || cfg.botName || "MOHAMMAD BADOL";
      ...
      if (!realArgs[0]) {
        ...
        msg += `├─━─━━──━─━─━\n`;
        msg += isOwner? `├‣ ${toBoldItalic("Owner")}: ${toBoldItalic("You")} ✅\n` : `├‣ ${toBoldItalic("Owner")}: ${toBoldItalic(ownerName)}\n`;
        msg += `╰━──━─━─━━─━─━❍`;
