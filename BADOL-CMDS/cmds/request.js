// request.js - V6.1 FINAL FIXED - DEV: MOHAMMAD BADOL
// Path: BADOL/request.js
// Fixed: help me bug + Approve button conflict + No main file edit needed + Notify
...
// ✅ Notify System - Approve/Reject যেখানে রিকোয়েস্ট করেছে সেখানেই যাবে
...
module.exports = {
  ...
  async BADOL({ event, api, args }) {
    ...
    // ✅ FIX: help me বাগ ফিক্স - শুধু /request বা /request help হলে হেল্প দেখাবে
    if (!args[0]) {
...
━━━━━━━━━━━━`;
    ...
    // ✅ FIX: request_approve_ দিয়ে শুরু - approve কমান্ডের সাথে কনফ্লিক্ট হবে না
    const buttons = {
      inline_keyboard: [[
  ...
  // ✅ FIX: user.js এর মতো নিজের ফাইলেই Callback - মেইন ফাইলে হাত দিতে হবে না
