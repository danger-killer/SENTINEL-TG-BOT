<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=32&pause=1000&color=00F2FF&center=true&vCenter=true&width=800&lines=𝄞⋆⃝🧚‍+𝐁𝐀𝐃𝐎𝐋-𝐓𝐆-𝐁𝐎𝐓+v2.0+🧚‍⋆⃝𝄞;ULTIMATE+DEVELOPER+GUIDE+FINAL+V4.0;Author:+MOHAMMAD+BADOL;ID:+6954597258;Auto+Button+Router+%7C+SafeName+Fix+%7C+110%2B+Cmds" alt="Typing SVG" />
</p>

<p align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=220&section=header&text=BADOL-TG-BOT&fontSize=75&fontColor=FFFFFF&animation=fadeIn&fontAlignY=35&desc=v2.0%20ULTIMATE%20-%20DEVELOPER%20GUIDE%20V4.0&descAlignY=55&descSize=18" />
</p>

<p align="center">
  <a href="https://t.me/mreditorzone"><img src="https://img.shields.io/badge/TELEGRAM-CHANNEL-0088CC?style=for-the-badge&logo=telegram&logoColor=white" /></a>
  <a href="https://wa.me/+8801782721761"><img src="https://img.shields.io/badge/WHATSAPP-CONTACT-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /></a>
  <a href="https://www.facebook.com/B4D9L999"><img src="https://img.shields.io/badge/FACEBOOK-PROFILE-1877F2?style=for-the-badge&logo=facebook&logoColor=white" /></a>
  <a href="https://t.me/B4D9L_007"><img src="https://img.shields.io/badge/DEVELOPER-BADOL-FF0000?style=for-the-badge&logo=telegram" /></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Version-2.0--ULTRA-00F2FF?style=for-the-badge&logo=telegram" />
  <img src="https://img.shields.io/badge/Node.js-18%2B-339933?style=for-the-badge&logo=node.js" />
  <img src="https://img.shields.io/badge/Commands-110%2B-gold?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Owner-MOHAMMAD%20BADOL-FF0000?style=for-the-badge" />
</p>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&pause=800&color=00FF00&center=true&vCenter=true&width=700&lines=🔥+Auto+Button+Router+%7C+No+Hardcode+Needed+🔥;🛡️+SafeName%28%29+Box+Break+Fix+🛡️;⚡+GBAN+%7C+Group+Approval+%7C+Request+Bypass+⚡;🎨+Premium+Box+Design+%7C+Badol+Engine+v2.0+🎨" alt="Features" />
</p>
...
![BADOL-TG-BOT](https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=0,2,6,11,20&height=60&section=header&text=BADOL%20ENGINE%20v2.0&fontSize=30&fontColor=FFFFFF&animation=fadeIn)
...
| # | 📚 Topic |
|---|----------|
| 1 | [বট আর্কিটেকচার ও ফোল্ডার স্ট্রাকচার](#-1-বট-আর্কিটেকচার-ও-ফোল্ডার-স্ট্রাকচার) |
| 2 | [Author Lock System](#-2-author-lock-system---must-know) |
| 3 | [কমান্ড ফাইলের গঠন](#-3-কমান্ড-ফাইলের-গঠন-badol-cmdscmds) |
| 4 | [ইভেন্ট ফাইলের গঠন](#-4-ইভেন্ট-ফাইলের-গঠন-badol-cmdsevents) |
| 5 | [সব প্যারামিটার তালিকা](#-5-সব-প্যারামিটার-তালিকা-badol-v20) |
| 6 | [message অবজেক্ট](#-6-message-অবজেক্টের-সব-ফাংশন-utiljs-v30) |
| 7 | [api ও ctx অবজেক্ট](#-7-api-ও-ctx-অবজেক্টের-সব-ফাংশন) |
| 8 | [🔥 AUTO BUTTON ROUTER](#-8--auto-button-router---file-name-based-most-important) |
| 9 | [🛡️ safeName()](#-9-️-safename---box-break-fix-must-use) |
| 10 | [📦 Box Design Rule](#-10--box-design-rule) |
| 11 | [বাটন / Keyboard](#-11-বাটন--inline--reply-keyboard) |
| 12 | [onReply](#-12-onreply--রিপ্লাই-সিস্টেম) |
| 13 | [onCallback](#-13-oncallback--বাটন-ক্লিক-সিস্টেম) |
| 14 | [onChat](#-14-onchat--সব-মেসেজ-শোনার-সিস্টেম) |
| 15 | [onLoad](#-15-onload--বট-স্টার্টে-একবার-চলে) |
| 16 | [ডেটাবেস](#-16-ডেটাবেস-globaldb-ও-গ্লোবাল-ম্যাপ) |
| 17 | [রোল / GBAN / Approval](#-17-রোল--পারমিশন-gban-group-approval--request-bypass) |
| 18 | [ইভেন্ট টাইপ তালিকা](#-18-ইভেন্ট-টাইপ-তালিকা-eventtype) |
| 19 | [সম্পূর্ণ উদাহরণ](#-19-সম্পূর্ণ-কমান্ড-উদাহরণ---100-fixed) |
| 20 | [AI Prompt](#-20-ai-prompt-to-generate-any-commandevent---copy-paste) |

---

## 🏗️ 1. বট আর্কিটেকচার ও ফোল্ডার স্ট্রাকচার

```bash
BADOL-TG-BOT/
├── 🚀 BADOL-TG-BOT.js         # মেইন কোর (GBAN, Owner Lock, DB Init, Login)
├── ⚙️ config.json             # কনফিগারেশন (New botInfo/ownerInfo + Old Adapter)
├── 📂 BADOL/
...
│   ├── 🛠️ util.js             # v3.0 - MessageUtils Class, CACHE_DIR, Helper Functions
│   ├── 🔑 login.js            # Telegraf Login
│   └── 📝 logger/             # banner, logs, color
└── 💎 BADOL-CMDS/
    ├── 📁 cmds/               # সকল কমান্ড .js (Custom Path) - 110+
...
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:00F2FF,100:000000&height=3&section=header&reversal=false" />
</p>
...
> ⚠️ **RULE:** সব Command/Event এ `author: "MOHAMMAD BADOL"` বাধ্যতামূলক! না হলে লোড হবে না বা Overwrite হয়ে যাবে!
...
<p align="center">
<img src="https://img.shields.io/badge/AUTO%20ROUTER-NO%20HARDCODE-00FF00?style=for-the-badge" />
</p>
...
## 🛡️ 9. 🛡️ safeName() - Box Break Fix (MUST USE)
...
```javascript
const userName = safeName(event.from.first_name, 16);
...
## 🎛️ 11. বাটন / Inline & Reply Keyboard
...
## 🛡️ 17. রোল / পারমিশন, GBAN, Group Approval & Request Bypass
...
## 🤖 20. AI PROMPT TO GENERATE ANY COMMAND/EVENT - COPY PASTE
...
### 👑 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐃 𝐁𝐘 𝐌𝐎𝐇𝐀𝐌𝐀𝐃 𝐁𝐀𝐃𝐎𝐋 👑

| Platform | Link |
|----------|------|
| 👤 Developer | Mohammad Badol |
| ✈️ Telegram | [@B4D9L_007](https://t.me/B4D9L_007) |
| 📢 Channel | [t.me/mreditorzone](https://t.me/mreditorzone) |
| 📱 WhatsApp | [+8801782721761](https://wa.me/+8801782721761) |
| 🔵 Facebook | [facebook.com/B4D9L](https://facebook.com/B4D9L999) |

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=120&section=footer&text=BADOL-TG-BOT%20v2.0&fontSize=35&fontColor=FFFFFF&animation=fadeIn&fontAlignY=65&desc=ULTIMATE%20DEVELOPER%20GUIDE%20FINAL%20V4.0&descAlignY=85" />

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=20&pause=1000&color=FF0000&center=true&vCenter=true&width=600&lines=Copyright+©+2026+BADOL-TG-BOT;All+Rights+Reserved;Made+With+❤️+By+MOHAMMAD+BADOL" alt="Footer" />
